...
import l2minius.gameserver.multverso.academy.AcademyRewards;
...
import l2minius.gameserver.listener.actor.player.impl.AcademyAnswerListener;
...
import l2minius.gameserver.utils.ValueSortMap;
...
public class CommunityBoardAcademy implements ScriptFile, ICommunityBoardHandler
{
	...
	private void showAcademList(Player player, int page)
	{
		...
		{
			htmltosend = htmltosend.replace("%mainbutton%", "<button value=\"Register\" action=\"bypass -h _bbsRegAcademyChar\" width=120 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\"><br>");
		}
		if (_academyList.contains(player))
		{
			htmltosend = htmltosend.replace("%mainbutton%", "<button value=\"Unregister\" action=\"bypass -h _bbsUnregisterFromAcademy\" width=120 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\"><br>");
		}
		else
		{
	...
	private void showAcademyChar(Player player, String academyChar, int pageNum)
	{
		...
		for (final Player academy : AcademyList.getAcademyList())
		{
			...
			sb.append("<button value=\"Invite To Academy\" action=\"bypass -h _bbsInviteToAcademy " + academy.getName() + " $items $price\" width=120 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\"><br>");
			sb.append("<button value=\"Back\" action=\"bypass -h _bbsShowAcademyList " + pageNum + "\" width=120 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\"><br>");
			sb.append("</center>");
			break;
		}
