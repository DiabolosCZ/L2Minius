...
import l2minius.gameserver.listener.actor.player.OnPlayerEnterListener;
...
public class CommunityClan extends Functions implements ScriptFile, ICommunityBoardHandler
{
	...
	private void showClanListPage(Player player, String searchClanName, String searchPlayerName, String searchAllianceName, int page)
	{
		...
		if (searchClanName.length() == 0 && searchPlayerName.length() == 0 && searchAllianceName.length() == 0)
		{
			...
			searchBoxes.append("<tr>");
			searchBoxes.append("<td width=180 align=center>");
			searchBoxes.append("<button action=\"bypass _bbsclan_clanList_ $findClanName __\" value=\"Find\" width=89 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\" />");
			searchBoxes.append("</td>");
			searchBoxes.append("<td width=180 align=center>");
			searchBoxes.append("<button action=\"bypass _bbsclan_clanList__ $findMemberName _\" value=\"Find\" width=89 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\" />");
			searchBoxes.append("</td>");
			searchBoxes.append("<td width=180 align=center>");
			searchBoxes.append("<button action=\"bypass _bbsclan_clanList___ $findAllyName\" value=\"Find\" width=89 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\" />");
			searchBoxes.append("</td>");
		}
		else if (searchClanName.length() > 0)
		{
			...
			searchBoxes.append("<tr>");
			searchBoxes.append("<td width=180 align=center>");
			searchBoxes.append("<button action=\"bypass _bbsclan_clanList___\" value=\"Clear\" width=89 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\" />");
			searchBoxes.append("</td>");
			searchBoxes.append("<td width=180 align=center>");
	...
	private void showClanDetailsPage(Player player, String searchClanName, String searchPlayerName, String searchAllianceName, int page, int clanId)
	{
		...
		{
			allianceCrest.append("<table cellpadding=0 cellspacing=0 width=8 height=16 background=Crest.crest_" + Config.REQUEST_ID + "_" + clan.getAlliance().getAllyCrestId() + ">");
		...
		if (clan.hasCrest())
		{
			clanCrest.append("<table cellpadding=0 cellspacing=0 width=16 height=16 background=Crest.crest_" + Config.REQUEST_ID + "_" + clan.getCrestId() + ">");
			clanCrest.append("<tr>");
		...
		if (clan.canEditNotice(player))
		{
			...
			{
				clanNotice.append("<button action=\"bypass _bbsclan_editClanNotice_" + convertBackTags(clan.getNotice()) + "\" value=\"Edit\" width=120 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\">");
			}
			else
			{
				clanNotice.append("<button action=\"bypass _bbsclan_editClanNotice_\" value=\"Edit\" width=120 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\">");
			}
			clanNotice.append("</td>");
			clanNotice.append("</tr>");
			clanNotice.append("</table>");
	...
	private void makeClanListTable(StringBuilder st, Player player, Clan clan, int index, String searchClanName, String searchPlayerName, String searchAllianceName, int page)
	{
		...
		if (clan.hasAllianceCrest())
		{
			st.append("<table cellpadding=0 cellspacing=0 width=8 height=16 background=Crest.crest_" + Config.REQUEST_ID + "_" + clan.getAlliance().getAllyCrestId() + ">");
			st.append("<tr>");
		...
		if (clan.hasCrest())
		{
			st.append("<table cellpadding=0 cellspacing=0 width=16 height=16 background=Crest.crest_" + Config.REQUEST_ID + "_" + clan.getCrestId() + ">");
			st.append("<tr>");
...
//import l2minius.gameserver.model.pledge.Clan;
//import l2minius.gameserver.model.pledge.Clan.SinglePetition;
...
//import l2minius.gameserver.utils.BbsUtil;
//import l2minius.gameserver.utils.Util;
//
//import org.slf4j.Logger;
//import org.slf4j.LoggerFactory;
