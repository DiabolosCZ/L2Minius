...
import l2minius.gameserver.model.entity.ChangeLogManager;
import l2minius.gameserver.model.entity.CCPHelpers.CCPSecondaryPassword;
import l2minius.gameserver.model.entity.forum.ForumBoard;
import l2minius.gameserver.model.entity.forum.ForumBoardType;
import l2minius.gameserver.model.entity.forum.ForumHandler;
import l2minius.gameserver.model.entity.forum.ForumPost;
...
public class _255_Tutorial extends Quest implements ScriptFile, OnPlayerEnterListener
{
	...
	/**
	 * If {@link #canChangeClass(l2minius.gameserver.model.Player, int) canChangeClass}, showing Tutorial Page with next Classes that player can advance to
	 * @param st
	 * @return
	 */
	private static boolean checkClassMaster(QuestState st)
	{
		...
		if (canChangeClass(player, jobLevel))
		{
			...
			html.append("<html noscrollbar><head><title>L2-Minius Newbie Tutorial</title></head>");
			html.append("<body>");
			...
			html.append("<font name=hs12 color=3399FF>L2-Minius</font>");
			html.append("<img src=\"L2UI.squaregray\" width=285 height=1/>");
			html.append("</td></tr></table>");
			html.append("<br></td></tr><tr>");
			html.append("<td align=center height=150>");
			html.append("<table width=280>");
			html.append("<tr><td align=center><br><font color=LEVEL name=hs12>Welcome to L2-Minius! </font></td></tr>");
			html.append("</table>");
			html.append("<br1>");
