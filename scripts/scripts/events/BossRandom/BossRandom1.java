...
public class BossRandom1 extends Functions implements ScriptFile
{

	private static final Logger LOG = LoggerFactory.getLogger(BossRandom1.class);
	private static boolean isActiveBossRandom1 = true;
	private static final int BossId = Config.RANDOM_BOSS_1_ID; // enter boss id
	private static Creature _boss;
	private static final int BossEventInterval = Config.RANDOM_BOSS_1_TIME; // 60*60*1000 - time
	...
	{
		_boss = NpcUtils.spawnSingle(BossId, Config.RANDOM_BOSS_1_X, Config.RANDOM_BOSS_1_Y, Config.RANDOM_BOSS_1_Z);
	}
	...
	public void onLoad()
	{
		...
		if (!Config.RANDOM_BOSS_1_ENABLE)
		{
			return;
		}
		...
		{
			isActiveBossRandom1 = false;
		}
		if (isActiveBossRandom1)
		{
			spawnBoss();
