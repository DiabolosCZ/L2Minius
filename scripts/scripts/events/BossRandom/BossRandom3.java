...
public class BossRandom3 extends Functions implements ScriptFile
{

	private static final Logger LOG = LoggerFactory.getLogger(BossRandom3.class);
	private static boolean isActiveBossRandom3 = true;
	private static final int BossId = Config.RANDOM_BOSS_3_ID; // enter boss id
	private static Creature _boss;
	private static final int BossEventInterval = Config.RANDOM_BOSS_3_TIME; // 60*60*1000 - time
	...
	{
		_boss = NpcUtils.spawnSingle(BossId, Config.RANDOM_BOSS_3_X, Config.RANDOM_BOSS_3_Y, Config.RANDOM_BOSS_3_Z);
	}
	...
	public void onLoad()
	{
		...
		if (!Config.RANDOM_BOSS_3_ENABLE)
		{
			return;
		}
		...
		{
			isActiveBossRandom3 = false;
		}
		if (isActiveBossRandom3)
		{
			spawnBoss();
