...
public class BossRandom2 extends Functions implements ScriptFile
{

	private static final Logger LOG = LoggerFactory.getLogger(BossRandom2.class);
	private static boolean isActiveBossRandom2 = true;
	private static final int BossId = Config.RANDOM_BOSS_2_ID; // enter boss id
	private static Creature _boss;
	private static final int BossEventInterval = Config.RANDOM_BOSS_2_TIME; // 60*60*1000 - time
	...
	{
		_boss = NpcUtils.spawnSingle(BossId, Config.RANDOM_BOSS_2_X, Config.RANDOM_BOSS_2_Y, Config.RANDOM_BOSS_2_Z);
	}
	...
	public void onLoad()
	{
		...
		if (!Config.RANDOM_BOSS_2_ENABLE)
		{
			return;
		}
		...
		{
			isActiveBossRandom2 = false;
		}
		if (isActiveBossRandom2)
		{
			spawnBoss();
