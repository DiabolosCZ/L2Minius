...
import l2minius.gameserver.model.AggroList.AggroInfo;
...
import l2minius.gameserver.model.actor.permission.PlayablePermissionList;
...
import l2minius.gameserver.templates.item.EtcItemTemplate;
...
public abstract class Playable extends Creature
{
	...
	public void doAttack(Creature target)
	{
		...
		{
			player.sendMessage(new CustomMessage("l2minius.gameserver.model.L2Playable.OutOfControl.ObserverNoAttack", player));
			return;
		}
