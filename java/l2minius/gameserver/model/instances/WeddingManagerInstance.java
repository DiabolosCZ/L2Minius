...
public class WeddingManagerInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("AcceptWedding"))
		{
			...
			player.sendMessage(new CustomMessage("l2minius.gameserver.model.instances.L2WeddingManagerMessage", player));
			player.setMaried(true);
			player.setMaryRequest(false);
			ptarget.sendMessage(new CustomMessage("l2minius.gameserver.model.instances.L2WeddingManagerMessage", ptarget));
			...
			Announcements.getInstance().announceByCustomMessage("l2minius.gameserver.model.instances.L2WeddingManagerMessage.announce", new String[]
			{
				player.getName(),
				ptarget.getName()
			});
