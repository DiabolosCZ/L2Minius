...
import l2minius.gameserver.model.MinionList;
...
import l2minius.gameserver.model.TeleportLocation;
import l2minius.gameserver.model.Territory;
import l2minius.gameserver.model.World;
import l2minius.gameserver.model.Zone.ZoneType;
import l2minius.gameserver.model.actor.listener.NpcListenerList;
import l2minius.gameserver.model.actor.recorder.NpcStatsChangeRecorder;
...
import l2minius.gameserver.network.serverpackets.AcquireSkillDone;
import l2minius.gameserver.network.serverpackets.AcquireSkillList;
...
import l2minius.gameserver.network.serverpackets.ExChangeNpcState;
import l2minius.gameserver.network.serverpackets.ExShowBaseAttributeCancelWindow;
import l2minius.gameserver.network.serverpackets.ExShowVariationCancelWindow;
import l2minius.gameserver.network.serverpackets.ExShowVariationMakeWindow;
...
import l2minius.gameserver.taskmanager.DecayTaskManager;
...
import l2minius.gameserver.templates.npc.Faction;
import l2minius.gameserver.templates.npc.NpcTemplate;
import l2minius.gameserver.templates.spawn.SpawnRange;
	...
	public void showSkillList(Player player)
	{
		...
		if (!(getTemplate().canTeach(classId) || getTemplate().canTeach(classId.getParent(player.getSex()))))
		{
			...
			else
			{
				...
				StringBuilder sb = new StringBuilder();
				sb.append("<html><head><body>");
				sb.append(new CustomMessage("l2minius.gameserver.model.instances.L2NpcInstance.WrongTeacherClass", player));
				sb.append("</body></html>");
				html.setHtml(sb.toString());
				player.sendPacket(html);
			}
