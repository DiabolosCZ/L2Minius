	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("Festival"))
		{
			...
			case 2: // Festival 2 xxxx
				...
				{
					player.sendMessage(new CustomMessage("l2minius.gameserver.model.instances.L2FestivalGuideInstance.InProgress", player));
					return;
				}
				...
				{
					player.sendMessage(new CustomMessage("l2minius.gameserver.model.instances.L2FestivalGuideInstance.NotEnoughSSType", player));
					return;
				}
