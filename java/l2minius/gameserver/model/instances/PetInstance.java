...
import l2minius.gameserver.model.PetData;
...
public class PetInstance extends Summon
{
	...
	class FeedTask extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			else if (getCurrentFed() <= 0.10 * getMaxFed())
			{
				...
				owner.sendMessage(new CustomMessage("l2minius.gameserver.model.instances.L2PetInstance.UnSummonHungryPet", owner));
				unSummon();
				return;
			}
	...
	public void addExpAndSp(long addToExp, long addToSp)
	{
		...
		if (old_level < _level)
		{
			owner.sendMessage(new CustomMessage("l2minius.gameserver.model.instances.L2PetInstance.PetLevelUp", owner).addNumber(_level));
