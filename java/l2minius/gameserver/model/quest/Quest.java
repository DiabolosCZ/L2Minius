...
import l2minius.commons.logging.LogUtils;
...
import l2minius.gameserver.network.serverpackets.ExNpcQuestHtmlMessage;
import l2minius.gameserver.network.serverpackets.ExQuestNpcLogList;
...
public class Quest
{
	...
	/**
	 * Добавляет нпц масив для слушателя при их убийстве, и обновлении пакетом {@link l2minius.gameserver.network.serverpackets.ExQuestNpcLogList}
	 * @param cond
	 * @param varName
	 * @param killIds
	 */
