...
import l2minius.commons.geometry.Polygon;
...
import l2minius.gameserver.model.base.BaseStats;
import l2minius.gameserver.model.base.ClassId;
import l2minius.gameserver.model.base.Element;
import l2minius.gameserver.model.base.SkillTrait;
...
import l2minius.gameserver.model.instances.ChestInstance;
...
import l2minius.gameserver.model.instances.TerritoryWardInstance;
...
import l2minius.gameserver.network.serverpackets.FlyToLocation;
import l2minius.gameserver.network.serverpackets.FlyToLocation.FlyType;
...
import l2minius.gameserver.skills.skillclasses.AIeffects;
import l2minius.gameserver.skills.skillclasses.Aggression;
import l2minius.gameserver.skills.skillclasses.Balance;
import l2minius.gameserver.skills.skillclasses.BeastFeed;
import l2minius.gameserver.skills.skillclasses.BuffCharger;
import l2minius.gameserver.skills.skillclasses.CPDam;
import l2minius.gameserver.skills.skillclasses.Call;
import l2minius.gameserver.skills.skillclasses.ChainHeal;
import l2minius.gameserver.skills.skillclasses.Charge;
import l2minius.gameserver.skills.skillclasses.ChargeSoul;
import l2minius.gameserver.skills.skillclasses.ClanGate;
import l2minius.gameserver.skills.skillclasses.CombatPointHeal;
import l2minius.gameserver.skills.skillclasses.Continuous;
import l2minius.gameserver.skills.skillclasses.Craft;
import l2minius.gameserver.skills.skillclasses.CurseDivinity;
import l2minius.gameserver.skills.skillclasses.DeathPenalty;
import l2minius.gameserver.skills.skillclasses.Decoy;
import l2minius.gameserver.skills.skillclasses.Default;
import l2minius.gameserver.skills.skillclasses.DefuseTrap;
import l2minius.gameserver.skills.skillclasses.DeleteHate;
import l2minius.gameserver.skills.skillclasses.DeleteHateOfMe;
import l2minius.gameserver.skills.skillclasses.DestroySummon;
import l2minius.gameserver.skills.skillclasses.DetectTrap;
import l2minius.gameserver.skills.skillclasses.Disablers;
import l2minius.gameserver.skills.skillclasses.Drain;
import l2minius.gameserver.skills.skillclasses.DrainSoul;
import l2minius.gameserver.skills.skillclasses.EffectsFromSkills;
import l2minius.gameserver.skills.skillclasses.EnergyReplenish;
import l2minius.gameserver.skills.skillclasses.ExtractStone;
import l2minius.gameserver.skills.skillclasses.FishingSkill;
import l2minius.gameserver.skills.skillclasses.Harvesting;
import l2minius.gameserver.skills.skillclasses.Heal;
import l2minius.gameserver.skills.skillclasses.HealPercent;
import l2minius.gameserver.skills.skillclasses.Imprison;
import l2minius.gameserver.skills.skillclasses.InstantJump;
import l2minius.gameserver.skills.skillclasses.KamaelWeaponExchange;
import l2minius.gameserver.skills.skillclasses.LearnSkill;
import l2minius.gameserver.skills.skillclasses.LethalShot;
import l2minius.gameserver.skills.skillclasses.MDam;
import l2minius.gameserver.skills.skillclasses.ManaDam;
import l2minius.gameserver.skills.skillclasses.ManaHeal;
import l2minius.gameserver.skills.skillclasses.ManaHealPercent;
import l2minius.gameserver.skills.skillclasses.NegateEffects;
import l2minius.gameserver.skills.skillclasses.NegateStats;
import l2minius.gameserver.skills.skillclasses.PDam;
import l2minius.gameserver.skills.skillclasses.PcBangPointsAdd;
import l2minius.gameserver.skills.skillclasses.PetSummon;
import l2minius.gameserver.skills.skillclasses.Recall;
import l2minius.gameserver.skills.skillclasses.ReelingPumping;
import l2minius.gameserver.skills.skillclasses.Refill;
import l2minius.gameserver.skills.skillclasses.Resurrect;
import l2minius.gameserver.skills.skillclasses.Ride;
import l2minius.gameserver.skills.skillclasses.SPHeal;
import l2minius.gameserver.skills.skillclasses.SelfSacrifice;
import l2minius.gameserver.skills.skillclasses.ShiftAggression;
import l2minius.gameserver.skills.skillclasses.Sowing;
import l2minius.gameserver.skills.skillclasses.Spawn;
import l2minius.gameserver.skills.skillclasses.Spoil;
import l2minius.gameserver.skills.skillclasses.StealBuff;
import l2minius.gameserver.skills.skillclasses.SummonHealPercent;
import l2minius.gameserver.skills.skillclasses.SummonItem;
import l2minius.gameserver.skills.skillclasses.SummonManaHealPercent;
import l2minius.gameserver.skills.skillclasses.SummonSiegeFlag;
import l2minius.gameserver.skills.skillclasses.Sweep;
import l2minius.gameserver.skills.skillclasses.TakeCastle;
import l2minius.gameserver.skills.skillclasses.TakeFlag;
import l2minius.gameserver.skills.skillclasses.TakeFortress;
import l2minius.gameserver.skills.skillclasses.TameControl;
import l2minius.gameserver.skills.skillclasses.TeleportNpc;
import l2minius.gameserver.skills.skillclasses.Toggle;
import l2minius.gameserver.skills.skillclasses.Transformation;
import l2minius.gameserver.skills.skillclasses.Unlock;
import l2minius.gameserver.skills.skillclasses.VitalityHeal;
import l2minius.gameserver.stats.Env;
import l2minius.gameserver.stats.Formulas;
import l2minius.gameserver.stats.StatTemplate;
import l2minius.gameserver.stats.Stats;
import l2minius.gameserver.stats.conditions.Condition;
import l2minius.gameserver.stats.funcs.Func;
...
public abstract class Skill extends StatTemplate implements Cloneable
{
	...
	public static enum SkillType
	{
		...
		REELING(ReelingPumping.class), REFILL(Refill.class), RESURRECT(Resurrect.class), RIDE(Ride.class), ROOT(Disablers.class), SELF_SACRIFICE(SelfSacrifice.class), SHIFT_AGGRESSION(ShiftAggression.class), SLEEP(Disablers.class), SOULSHOT, SOWING(Sowing.class), SPHEAL(SPHeal.class), SPIRITSHOT, SPOIL(Spoil.class), STEAL_BUFF(StealBuff.class), SPAWN(Spawn.class), CURSE_DIVINITY(CurseDivinity.class), STUN(Disablers.class), SUMMON(l2minius.gameserver.skills.skillclasses.Summon.class),
	...
	{
		return ((_id >= 370) && (_id <= 391)) || ((_id >= 611) && (_id <= 616)) || (_id == 88000) || (_id == 88001) || (_id == 88002) || (_id == 88003) || (_id == 88004) || (_id == 88005);
	}
