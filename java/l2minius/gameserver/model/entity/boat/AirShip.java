...
import l2minius.gameserver.network.serverpackets.ExAirShipInfo;
import l2minius.gameserver.network.serverpackets.ExGetOffAirShip;
import l2minius.gameserver.network.serverpackets.ExGetOnAirShip;
import l2minius.gameserver.network.serverpackets.ExMoveToLocationAirShip;
import l2minius.gameserver.network.serverpackets.ExMoveToLocationInAirShip;
import l2minius.gameserver.network.serverpackets.ExStopMoveAirShip;
import l2minius.gameserver.network.serverpackets.ExStopMoveInAirShip;
import l2minius.gameserver.network.serverpackets.ExValidateLocationInAirShip;
