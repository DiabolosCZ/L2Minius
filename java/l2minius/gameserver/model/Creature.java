...
import l2minius.commons.permission.Permission;
import l2minius.commons.threading.RunnableImpl;
import l2minius.commons.util.Rnd;
import l2minius.commons.util.concurrent.atomic.AtomicState;
...
import l2minius.gameserver.geodata.GeoMove;
...
import l2minius.gameserver.instancemanager.ServerVariables;
import l2minius.gameserver.model.GameObjectTasks.AltMagicUseTask;
import l2minius.gameserver.model.GameObjectTasks.CastEndTimeTask;
import l2minius.gameserver.model.GameObjectTasks.HitTask;
import l2minius.gameserver.model.GameObjectTasks.MagicCheckTask;
import l2minius.gameserver.model.GameObjectTasks.MagicLaunchedTask;
import l2minius.gameserver.model.GameObjectTasks.MagicUseTask;
import l2minius.gameserver.model.GameObjectTasks.NotifyAITask;
import l2minius.gameserver.model.Skill.SkillTargetType;
...
import l2minius.gameserver.model.actor.permission.CharPermissionList;
import l2minius.gameserver.model.actor.recorder.CharStatsChangeRecorder;
...
import l2minius.gameserver.model.instances.MinionInstance;
...
import l2minius.gameserver.network.serverpackets.Attack;
import l2minius.gameserver.network.serverpackets.AutoAttackStart;
import l2minius.gameserver.network.serverpackets.AutoAttackStop;
import l2minius.gameserver.network.serverpackets.ChangeMoveType;
import l2minius.gameserver.network.serverpackets.CharMoveToLocation;
...
import l2minius.gameserver.network.serverpackets.MagicSkillCanceled;
...
import l2minius.gameserver.stats.Calculator;
import l2minius.gameserver.stats.Env;
import l2minius.gameserver.stats.Formulas;
import l2minius.gameserver.stats.Formulas.AttackInfo;
import l2minius.gameserver.stats.StatFunctions;
...
import l2minius.gameserver.taskmanager.GlobalPvPZoneTaskManager;
import l2minius.gameserver.taskmanager.LazyPrecisionTaskManager;
import l2minius.gameserver.taskmanager.RegenTaskManager;
import l2minius.gameserver.templates.CharTemplate;
import l2minius.gameserver.templates.item.ItemTemplate.Grade;
