...
public class FishingSkill extends Skill
{
	...
	public void useSkill(Creature caster, List<Creature> targets)
	{
		...
		int group = l2minius.gameserver.model.Fishing.getFishGroup(lure.getItemId());
		int type = l2minius.gameserver.model.Fishing.getRandomFishType(lureId);
		int lvl = l2minius.gameserver.model.Fishing.getRandomFishLvl(player);
