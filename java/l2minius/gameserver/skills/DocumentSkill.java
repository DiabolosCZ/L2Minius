...
import l2minius.gameserver.model.base.EnchantSkillLearn;
...
public final class DocumentSkill extends DocumentBase
{
	...
	public class DocSkill
	{
		...
		public List<l2minius.gameserver.model.Skill> skills = new ArrayList<l2minius.gameserver.model.Skill>();
		public List<l2minius.gameserver.model.Skill> currentSkills = new ArrayList<l2minius.gameserver.model.Skill>();
	}

	private final int skillToParse;
	private DocSkill currentSkill;
	private Set<String> usedTables = new HashSet<String>();
	private List<l2minius.gameserver.model.Skill> skillsInFile = new LinkedList<l2minius.gameserver.model.Skill>();
	...
	protected List<l2minius.gameserver.model.Skill> getSkills()
	{
		return skillsInFile;
	}
	...
	protected void parseSkill(Node n)
	{
		...
		try
		{
			...
			for (int i = 0; i < lastLvl; i++)
			{
				...
				l2minius.gameserver.model.Skill current = currentSkill.currentSkills.get(i);
	...
	{
		currentSkill.currentSkills = new ArrayList<l2minius.gameserver.model.Skill>(currentSkill.sets.length);
