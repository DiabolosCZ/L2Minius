...
import l2minius.gameserver.model.RecipeComponent;
...
import l2minius.gameserver.network.serverpackets.RecipeShopItemInfo;
...
public class RequestRecipeShopMakeDo extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			manufacturer.sendMessage(new CustomMessage("l2minius.gameserver.RecipeController.NoRecipe", manufacturer).addString(recipeList.getRecipeName()));
			buyer.sendMessage(new CustomMessage("l2minius.gameserver.RecipeController.NoRecipe", manufacturer).addString(recipeList.getRecipeName()));
			return;
		}
		...
		manufacturer.sendMessage(new CustomMessage("l2minius.gameserver.RecipeController.GotOrder", manufacturer).addString(recipeList.getRecipeName()));
