...
import l2minius.gameserver.network.serverpackets.AskJoinAlliance;
...
public class RequestJoinAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2minius.gameserver.clientpackets.RequestJoinAlly.InvitePenalty", activeChar));
			return;
		}
