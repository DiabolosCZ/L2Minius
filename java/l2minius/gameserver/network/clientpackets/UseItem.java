...
public class UseItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		 ...
		 * {
		 * activeChar.sendMessage(new CustomMessage("l2minius.gameserver.network.l2.c2s.UseItem.NotUseIsEvents", activeChar));
		 * return;
		 * }
		 */
		...
		{
			activeChar.sendMessage(new CustomMessage("l2minius.gameserver.network.l2.c2s.UseItem.NotUseIsFlag", activeChar));
			return;
		}
