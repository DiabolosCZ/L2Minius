	...
	private class ScheduleAuctionTask extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			case CREATED:
			{
				...
				{
					String[] params = {};
					Announcements.getInstance().announceByCustomMessage("l2minius.gameserver.model.instances.L2ItemAuctionBrokerInstance.announce." + _auction.getInstanceId(), params);
				}
				checkAndSetCurrentAndNextAuction();
				break;
			}
