...
import l2minius.commons.annotations.NotNull;
...
import l2minius.gameserver.data.ConfigParser;
...
import l2minius.gameserver.utils.DynamicConfig;
...
public final class ConfigHolder extends AbstractHolder
{
	...
	public static String getString(String name)
	{
		...
		if (string == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getString"));
		}
		return string;
	}
	...
	public static File getFilePath(String name)
	{
		...
		if (filePath == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getFilePath"));
		}
		return filePath;
	}
	...
	public static Pattern getPattern(@NotNull final String name)
	{
		if (name == null)
		{
			throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "name", "l2minius/gameserver/ConfigHolder", "getPattern"));
		}
		final DynamicConfig value = getInstance().getOrLoad(name, Pattern.class);
		final Pattern pattern = value.getPattern();
		if (pattern == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getPattern"));
		}
		return pattern;
	}
	...
	public static Location getLocation(String name)
	{
		...
		if (location == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getLocation"));
		}
		return location;
	}
	...
	public static ChatType getChatType(String name)
	{
		...
		if (chatType == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getChatType"));
		}
		return chatType;
	}
	...
	public static <E> E getEnum(String name, Class<E> type)
	{
		...
		if (classType == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getEnum"));
		}
		return classType;
	}
	...
	public static ServerType getServerType(String name)
	{
		...
		if (serverType == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getServerType"));
		}
		return serverType;
	}
	...
	public static AbnormalEffect getAbnormalEffect(String name)
	{
		...
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getAbnormalEffect"));
		}
	...
	public static int[][] getMultiIntArray(String name)
	{
		...
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getMultiIntArray"));
		}
	...
	public static long[][] getMultiLongArray(String name)
	{
		...
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getMultiLongArray"));
		}
	...
	public static double[][] getMultiDoubleArray(String name)
	{
		...
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getMultiDoubleArray"));
		}
	...
	public static String[][] getMultiStringArray(String name)
	{
		...
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getMultiStringArray"));
		}
	...
	public static <E> E[][] getMultiArray(String name, Class<E> primaryType)
	{
		...
		if (array2 == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getMultiArray"));
		}
		return array2;
	}
	...
	public static int[] getIntArray(String name)
	{
		...
		if (intArray == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getIntArray"));
		}
		return intArray;
	}
	...
	public static long[] getLongArray(String name)
	{
		...
		if (longArray == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getLongArray"));
		}
		return longArray;
	}
	...
	public static double[] getDoubleArray(String name)
	{
		...
		if (doubleArray == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getDoubleArray"));
		}
		return doubleArray;
	}
	...
	public static boolean[] getBooleanArray(String name)
	{
		...
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getBooleanArray"));
		}
		return booleanArray;
	}
	...
	public static String[] getStringArray(String name)
	{
		...
		if (stringArray == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getStringArray"));
		}
		return stringArray;
	}
	...
	public static <E> E[] getArray(String name, Class<E> primaryType)
	{
		...
		if (array2 == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getArray"));
		}
		return array2;
	}
	...
	public static <E, T> Map<E, T> getMap(String name, Class<E> firstType, Class<T> secondType)
	{
		...
		if (map == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getMap"));
		}
		return map;
	}
	...
	public static <E, T> Map.Entry<E, T> getMapEntry(String name, Class<E> firstType, Class<T> secondType)
	{
		...
		if (entry == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getMapEntry"));
		}
		return entry;
	}
	...
	public static StatsSet getStatsSet(String name, Object... keysAndClasses)
	{
		...
		if (set == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getStatsSet"));
		}
		return set;
	}
	...
	public static List<StatsSet> getStatsSetList(String name, Object... keysAndClasses)
	{
		...
		if (list == null)
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getStatsSetList"));
		}
		return list;
	}
	...
	public SelectorConfig getSelectorConfig()
	{
		...
		{
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getSelectorConfig"));
		}
	...
	private DynamicConfig getOrLoad(String name, Class<?> type)
	{
		...
		if (convertedConfig != null)
		{
			...
			{
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getOrLoad"));
			}
	...
	private DynamicConfig getOrLoadMap(String name, Class<?> firstType, @SuppressWarnings("rawtypes") final Class<?> secondType)
	{
		...
		if (convertedConfig != null)
		{
			...
			if (dynamicConfig == null)
			{
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getOrLoadMap"));
			}
			return dynamicConfig;
		}
		else
	...
	private DynamicConfig getOrLoadMapEntry(String name, Class<?> firstType, Class<?> secondType)
	{
		...
		if (convertedConfig != null)
		{
			...
			if (dynamicConfig == null)
			{
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getOrLoadMapEntry"));
			}
			return dynamicConfig;
		}
		else
	...
	private DynamicConfig getOrLoadStatsSet(String name, Object... keysAndClasses)
	{
		...
		if (convertedConfig != null)
		{
			...
			if (dynamicConfig == null)
			{
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "getOrLoadStatsSet"));
			}
			return dynamicConfig;
		}
		else
	...
	private DynamicConfig loadObject(String name, Class<?> type, boolean logError)
	{
		...
		try
		{
			...
			if (dynamicConfig == null)
			{
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "loadObject"));
			}
			return dynamicConfig;
		}
	...
	private DynamicConfig loadMap(String name, Class<?> firstType, Class<?> secondType, boolean logError)
	{
		...
		try
		{
			...
			if (dynamicConfig == null)
			{
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "loadMap"));
			}
			return dynamicConfig;
		}
		catch (NumberFormatException e)
	...
	private DynamicConfig loadMapEntry(String name, Class<?> firstType, Class<?> secondType, boolean logError)
	{
		...
		try
		{
			...
			if (dynamicConfig == null)
			{
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "loadMapEntry"));
			}
			return dynamicConfig;
		}
		catch (NumberFormatException e)
	...
	private DynamicConfig loadStatsSet(String name, boolean logError, Object... keysAndClasses)
	{
		...
		try
		{
			...
			if (dynamicConfig == null)
			{
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "loadStatsSet"));
			}
			return dynamicConfig;
		}
		catch (NumberFormatException e)
	...
	private DynamicConfig loadStatsSetList(String name, boolean logError, Object... keysAndClasses)
	{
		...
		try
		{
			...
			if (dynamicConfig == null)
			{
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2minius/gameserver/ConfigHolder", "loadStatsSetList"));
			}
			return dynamicConfig;
		}
		catch (NumberFormatException e)
