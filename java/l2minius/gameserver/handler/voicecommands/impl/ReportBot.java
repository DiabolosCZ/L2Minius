...
public class ReportBot implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player activeChar, String args)
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2minius.gameserver.handler.voicecommands.impl.randomcommands.message4", activeChar));
			return false;
		}
	...
	private void botReportcommand(Player activeChar, String typeofreport, String moreinfo)
	{
		if (Config.ENABLE_AUTO_HUNTING_REPORT)
		{
			...
			{
				activeChar.sendMessage(new CustomMessage("l2minius.gameserver.handler.voicecommands.impl.randomcommands.message15", activeChar));
			}
		}
		else
		{
			activeChar.sendMessage(new CustomMessage("l2minius.gameserver.handler.voicecommands.impl.randomcommands.message16", activeChar));
		}
	}
