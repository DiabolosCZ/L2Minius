...
import static l2minius.gameserver.model.Zone.ZoneType.no_restart;
import static l2minius.gameserver.model.Zone.ZoneType.no_summon;
...
import l2minius.gameserver.model.entity.Couple;
...
public class Wedding implements IVoicedCommandHandler
{
	private static class CoupleAnswerListener implements OnAnswerListener
	{
		...
		public void sayYes()
		{
			...
			player1.sendMessage(new CustomMessage("l2minius.gameserver.model.L2Player.EngageAnswerYes", player2));
		}
		...
		public void sayNo()
		{
			...
			player1.sendMessage(new CustomMessage("l2minius.gameserver.model.L2Player.EngageAnswerNo", player2));
		}
	}
