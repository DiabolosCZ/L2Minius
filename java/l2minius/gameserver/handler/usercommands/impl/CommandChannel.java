package l2minius.gameserver.handler.usercommands.impl;

import l2minius.gameserver.handler.usercommands.IUserCommandHandler;
import l2minius.gameserver.model.Party;
import l2minius.gameserver.model.Player;
import l2minius.gameserver.network.serverpackets.ExMultiPartyCommandChannelInfo;
...
public class CommandChannel implements IUserCommandHandler
{
	...
	public boolean useUserCommand(int id, Player activeChar)
	{
		...
		case 93: // channeldelete
			...
			{
				l2minius.gameserver.model.CommandChannel channel = activeChar.getParty().getCommandChannel();
