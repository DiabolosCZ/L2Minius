...
import l2minius.gameserver.network.loginservercon.gspackets.ChangePassword;
...
import l2minius.gameserver.randoms.GeoLocation;
...
public class AdminEditChar implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(Enum comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		else if (fullString.startsWith("admin_setsubclass"))
		{
			...
			if (st.countTokens() > 1)
			{
				...
				{
					activeChar.sendMessage(new CustomMessage("l2minius.gameserver.model.instances.L2VillageMasterInstance.SubclassCouldNotBeAdded", activeChar));
					return false;
				}
	...
	private void setSubclass(Player activeChar, Player player)
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2minius.gameserver.model.instances.L2VillageMasterInstance.NoSubAtThisTime", activeChar));
			return;
		}
