package l2minius.gameserver.data.xml.parser;
...
import l2minius.commons.data.xml.AbstractDirParser;
import l2minius.gameserver.Config;
import l2minius.gameserver.data.xml.holder.EventHolder;
import l2minius.gameserver.model.entity.events.EventAction;
import l2minius.gameserver.model.entity.events.EventType;
import l2minius.gameserver.model.entity.events.GlobalEvent;
import l2minius.gameserver.model.entity.events.actions.ActiveDeactiveAction;
import l2minius.gameserver.model.entity.events.actions.AnnounceAction;
import l2minius.gameserver.model.entity.events.actions.GiveItemAction;
import l2minius.gameserver.model.entity.events.actions.IfElseAction;
import l2minius.gameserver.model.entity.events.actions.InitAction;
import l2minius.gameserver.model.entity.events.actions.NpcSayAction;
import l2minius.gameserver.model.entity.events.actions.OpenCloseAction;
import l2minius.gameserver.model.entity.events.actions.PlaySoundAction;
import l2minius.gameserver.model.entity.events.actions.RefreshAction;
import l2minius.gameserver.model.entity.events.actions.SayAction;
import l2minius.gameserver.model.entity.events.actions.SpawnDespawnAction;
import l2minius.gameserver.model.entity.events.actions.StartStopAction;
import l2minius.gameserver.model.entity.events.actions.TeleportPlayersAction;
import l2minius.gameserver.model.entity.events.objects.BoatPoint;
import l2minius.gameserver.model.entity.events.objects.CTBTeamObject;
import l2minius.gameserver.model.entity.events.objects.CastleDamageZoneObject;
import l2minius.gameserver.model.entity.events.objects.DoorObject;
import l2minius.gameserver.model.entity.events.objects.FortressCombatFlagObject;
import l2minius.gameserver.model.entity.events.objects.SiegeToggleNpcObject;
import l2minius.gameserver.model.entity.events.objects.SpawnExObject;
import l2minius.gameserver.model.entity.events.objects.StaticObjectObject;
import l2minius.gameserver.model.entity.events.objects.TerritoryWardObject;
import l2minius.gameserver.model.entity.events.objects.ZoneObject;
...
import l2minius.gameserver.network.serverpackets.components.SysString;
...
public final class EventParser extends AbstractDirParser<EventHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		for (Iterator<Element> iterator = rootElement.elementIterator("event"); iterator.hasNext();)
		{
			...
			try
			{
				eventClass = (Class<GlobalEvent>) Class.forName("l2minius.gameserver.model.entity.events.impl." + impl + "Event");
			}
			...
			set.set("id", id);
			set.set("name", name);
			set.set("eventClass", "l2minius.gameserver.model.entity.events.impl." + impl + "Event");
...
//
//		        EventAction action = new l2minius.gameserver.model.entity.events.actions.VoicedCommandToClanLeadersAction(bypass);
//		        actions.add(action);
//		      }
...
//		        String bypass = actionElement.attributeValue("bypass");
//
//		        EventAction action = new l2minius.gameserver.model.entity.events.actions.VoicedCommandToAllPlayersAction(bypass);
//		        actions.add(action);
//		      }
...
//		        String bypass = actionElement.attributeValue("bypass");
//
//		        EventAction action = new l2minius.gameserver.model.entity.events.actions.VoicedCommandToAllParticipantsAction(bypass);
//		        actions.add(action);
//		      }
