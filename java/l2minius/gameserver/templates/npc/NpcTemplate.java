package l2minius.gameserver.templates.npc;
...
import l2minius.commons.util.TroveUtils;
import l2minius.gameserver.ai.CharacterAI;
import l2minius.gameserver.data.xml.holder.FakePlayerNpcsHolder;
...
import l2minius.gameserver.model.reward.RewardList;
import l2minius.gameserver.model.reward.RewardType;
...
public final class NpcTemplate extends CharTemplate
{
	...
	private void setType(String type)
	{
		...
		try
		{
			classType = (Class<NpcInstance>) Class.forName("l2minius.gameserver.model.instances." + type + "Instance");
		}
	...
	private void setAI(String ai)
	{
		...
		try
		{
			classAI = (Class<CharacterAI>) Class.forName("l2minius.gameserver.ai." + ai);
		}
		catch (ClassNotFoundException e)
		{
