...
import l2minius.gameserver.network.serverpackets.NpcSay;
...
public class Functions
{
	...
	{
		return mob != null && mob.isMonster() && !mob.isRaid() && killer != null && killer.getPlayer() != null && killer.getLevel() - mob.getLevel() < 40;
	}
